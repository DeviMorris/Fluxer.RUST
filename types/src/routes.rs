...
impl Routes {
    ...
    pub fn guild_transfer_ownership(guild_id: &str) -> String {
    ...
    pub fn guild_detached_banner(guild_id: &str) -> String {
        format!("/guilds/{guild_id}/detached-banner")
    }

    pub fn guild_disallow_unclaimed_accounts(guild_id: &str) -> String {
        format!("/guilds/{guild_id}/disallow-unclaimed-accounts")
    }
